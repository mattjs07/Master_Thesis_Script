...
df[ ,av_spell_12m_trunc := max(episode_rac_numero_mois, na.rm = TRUE) ,by=list(indiv, episode_rac_numero)]
df[ ,av_spell_12m := max(episode_rac_numero_mois, na.rm = TRUE) ,by=list(indiv, episode_rac_numero)]
df[ ,av_spell_12m := max(episode_rac_numero_mois, na.rm = TRUE) ,by=list(indiv, episode_rac_numero)]
